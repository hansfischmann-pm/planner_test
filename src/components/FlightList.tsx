                ...
                <div className="flex gap-2">
                    {onViewAttribution && (
                        <button
                            ...
                            className="px-4 py-2 bg-white border border-blue-200 text-blue-700 dark:bg-gray-800 dark:border-blue-700 dark:text-blue-300 rounded-lg text-sm font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors flex items-center gap-2"
                        >
